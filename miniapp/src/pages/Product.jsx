...
export default function Product() {
  ...
  return (
    <div className="pb-40">
      ...
      {/* Pastki navigatsiya paneli (BottomNav) doim ko'rinib turishi kerak,
          shuning uchun bu panel bevosita uning USTIGA joylashadi (bottom: 0
          emas) — aks holda ikkalasi bir joyda ustma-ust tushib, bu tugma
          navigatsiya orqasida yashirinib qolardi. */}
      <div className="fixed left-0 right-0 bg-white border-t border-beige px-4 py-3 flex items-center gap-3 z-30"
